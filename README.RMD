...
et une autre avec **R** associé au costaud **ranger** ...Juste une remarque en passant, je ne suis pas encore copain avec lui
...
Version stable sur Spyrales : cliquez sur ce lien [![Binder](http://mybinder.org/badge_logo.svg)](http://mybinder.org/v2/gh/spyrales/la-piscine/master?urlpath=shiny/mlExplore/)
