...
Après avoir récupéré tous les scripts depuis mon dépôt ( [gillesdelille](https://github.com/GillesDeLille/mlExplore) ) ou depuis [la-piscine](https://github.com/spyrales/la-piscine/) et utiliser le sytème de contrôle de version [git]( https://spyrales.netlify.app/blog/20200329-memogit/), déposer le dossier mlExplore
